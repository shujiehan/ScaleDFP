...
public interface Instance extends Serializable {
    ...
    /**
     * Gets the serializable serial number of the instance.
     * @return the serial number
     */
    public String getSerialNumber();

    /**
     * Sets the serializable serial number.
     * @param serialNumber
     */
