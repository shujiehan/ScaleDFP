...
public class InstanceImpl implements MultiLabelInstance {
     ...
     * Poisson weights.
     */
    protected List<Integer> poissonWeights;
    ...
    /**
     * Shujie Add:
     * Gets Poisson weights.
     * @return poisson weights
     */
    public List<Integer> getPoissonWeights() {
        return this.poissonWeights;
    }

    /**
     * Shujie Add:
     * Sets Poisson weights.
     */
    public void setPoissonWeights(List<Integer> poissonWeights) {
    ...
    public void keepPredictedVotes(double[] votes){
        this.predictedVotes = votes;
    }

    @Override
    public double[] getPredictedVotes() {
        return this.predictedVotes;
    }
}
