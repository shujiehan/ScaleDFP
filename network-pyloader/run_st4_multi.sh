...
PREFIX="/home/shujie"
DATA_PATH="${PREFIX}/bb_raw_${PEER}p/${COLLECTOR}/"
#DATA_PATH="/home/shujie/backblaze/"
FRAC=0.1
TEST="accuracy"
...
TRAIN_PATH="${PREFIX}/bb_pyloader_${PEER}p_random${FRAC}/st4_train_p30n7v30_fix_20/allocate_d${DOWN_RATIO}p${LAMBDA_P}n${LAMBDA_N}r${SEED}/"
TEST_PATH="${PREFIX}/bb_pyloader_${PEER}p_random${FRAC}/st4_test_p30n7v30_fix_20/allocate/"
ITER_DAYS=400
PATH_FEATUERS="features_erg/st4_all.txt"
OPTIONS="3,4,7"
FORGET_TYPE="sliding"
LABEL_DAYS=20
POSITIVE_WINDOW=30
...
REPORT_NAME="st4_p30n7v30_fix_20"
SAVE_DIR="save_model/"
