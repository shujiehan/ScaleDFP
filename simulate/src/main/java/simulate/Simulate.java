...
public class Simulate extends AbstractPredict{
    ...
    public IntOption indexPoissonWeightOption = new IntOption("indexPoissonWeight", 'f',
            "start index of Poisson weight", 0);

    public IntOption numPoissonWeightOption = new IntOption("numPoissonWeight", 'n',
            "number of Poisson weights on this receiver", 0);
    ...
    public void init() throws Exception {
        ...
        // Shujie added on May 27, 2024
        this.indexPoissonWeight = indexPoissonWeightOption.getValue();
        this.numPoissonWeight = numPoissonWeightOption.getValue();
